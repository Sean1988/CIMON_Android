 ...
 * provide an expandable list activity or fragment.  This is to allow loading of
 * a LoaderManager in expandable list activity ***  
 * <p>
 ...
 */
public class ExpandableListActivity extends FragmentActivity implements
    ...
    public void onContentChanged() {
        ...
        View emptyView = findViewById(R.id.empty);	//com.android.internal.R.id.empty
        mList = (ExpandableListView)findViewById(R.id.list);	//com.android.internal.R.id.list
        if (mList == null) {
    ...
    private void ensureList() {
        ...
        setContentView(R.layout.expandable_list_content);	//com.android.internal.R.layout.expandable_list_content
    }
